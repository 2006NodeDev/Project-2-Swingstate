...
function getAllUsersService() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user_dao_1.getAllUsers()];
...
function getUserByIDService(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user_dao_1.getUserById(id)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
...
function saveOneUserService(newUser) {
    return __awaiter(this, void 0, void 0, function () {
        var savedUser, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, user_dao_1.saveOneUser(newUser)
...
exports.saveOneUserService = saveOneUserService;
function getAdditionalUserInfoService(userId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user_dao_1.getAdditionalInfoById(userId)];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
}
exports.getAdditionalUserInfoService = getAdditionalUserInfoService;
